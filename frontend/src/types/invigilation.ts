...
export type ReattemptAuthStatus = 'AUTHORIZED' | 'CONSUMED';

export interface ReattemptInfo {
  id: string;
  status: ReattemptAuthStatus;
...
export interface ProctorReattemptAuthorizationResponse {
