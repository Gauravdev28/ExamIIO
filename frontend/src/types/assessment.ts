...
export interface AudienceResolution {
  ...
  audience_mode?: 'ALL_STUDENTS' | 'ALL_ACTIVE' | 'SPECIFIC';
  section_student_count: number;
  individual_student_count: number;
  overlap_count: number;
  total_eligible: number;
  total_craft_society_students?: number;
...
export interface AssessmentAdminItem {
  ...
  multiple_face_detection_enabled?: boolean;
  gaze_detection_enabled?: boolean;
  head_movement_detection_enabled?: boolean;
  max_confirmed_violations?: number;
