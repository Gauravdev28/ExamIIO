                          ...
                          <div key={idx} className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 text-xs font-mono space-y-2">
                            ...
                            <div className="grid grid-cols-2 gap-2.5">
                              <div>
                                ...
                                <pre className="p-2.5 rounded-lg bg-white border border-slate-200 text-slate-800 overflow-x-auto">{tc.input_data || '(empty)'}</pre>
                              </div>
                              <div>
                                <span className="text-slate-500 block font-semibold mb-1">Expected Output:</span>
                                <pre className="p-2.5 rounded-lg bg-white border border-slate-200 text-slate-800 overflow-x-auto">{tc.expected_output}</pre>
                              </div>
                            </div>
                          </div>
                        ))}
              ...
              {data.question_type === 'SQL' && data.sql_config && (
                <div className="space-y-4">
                  ...
                  <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                    ...
                    <pre className="p-3 rounded-lg bg-white text-slate-800 font-mono text-xs overflow-x-auto border border-slate-200">
