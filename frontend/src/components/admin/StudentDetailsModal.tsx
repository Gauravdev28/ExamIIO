            ...
            {isEditing ? (
              ...
              <div className="space-y-3 text-xs">
                ...
                <div className="flex justify-between py-2 border-b border-slate-100 items-center">
                  <span className="text-slate-700 font-semibold">Coins Earned</span>
                  <span className="font-mono font-bold text-amber-600 bg-amber-50 px-2.5 py-0.5 rounded border border-amber-200">
                    🪙 {currentStudent.coins ?? 0} Coins
                  </span>
                </div>
                <div className="flex justify-between py-2 border-b border-slate-100 items-center">
