    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 space-y-16">
      ...
      <div className="space-y-4 text-center max-w-3xl mx-auto">
        ...
        <p className="text-base text-slate-600 leading-relaxed">
          ExamIIO was conceived to bridge the gap between rigorous coding evaluations and humane, transparent examination supervision.
        </p>
      </div>
      ...
      <Card className="p-8 sm:p-10 space-y-6">
        ...
        <p className="text-sm sm:text-base text-slate-600 leading-relaxed">
          ExamIIO solves this by combining automated multi-language code execution with real-time proctoring tools. We empower academic institutions and hiring teams to conduct high-stakes assessments with confidence, objectivity, and mutual respect between candidates and proctors.
        </p>
      </Card>
