    ...
    <div className="w-full px-4 sm:px-6 lg:px-8 py-12 md:py-16 space-y-16">
      ...
      <div className="space-y-4 text-center max-w-3xl mx-auto">
        ...
        <p className="text-base text-slate-600 leading-relaxed">
          Explore the core capabilities that make ExamIIO a dependable choice for academic departments and technical certification bodies.
        </p>
      </div>
      ...
      <div className="rounded-2xl bg-white border border-slate-200 p-8 sm:p-10 text-center space-y-4 shadow-sm max-w-4xl mx-auto">
        <h3 className="text-xl font-bold text-slate-900">Experience ExamIIO in Action</h3>
