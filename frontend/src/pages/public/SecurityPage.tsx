    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 space-y-16">
      ...
      <div className="space-y-4 text-center max-w-3xl mx-auto">
        ...
        <p className="text-base text-slate-600 leading-relaxed">
          ExamIIO provides a secure examination environment through layered technical controls, server-authoritative state, and respectful human supervision.
        </p>
      </div>
      ...
      <div className="rounded-2xl bg-white border border-slate-200 p-8 space-y-4 shadow-sm">
        ...
        <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
          We believe in honest, grounded security. No assessment platform can legitimately guarantee 100% cheat prevention. ExamIIO focuses on reducing cheating opportunities through controlled environments, assisting proctors with actionable signals, and ensuring transparent audit trails for institutional accountability.
        </p>
      </div>
    </div>
  );
