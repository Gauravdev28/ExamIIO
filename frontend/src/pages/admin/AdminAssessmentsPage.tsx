...
import { getAdminAssessments, publishAssessment, deleteAssessment } from '../../api/assessments';
...
export const AdminAssessmentsPage: React.FC = () => {
  ...
  const handleDeleteDraftFromList = async (a: AssessmentAdminItem) => {
    if (!window.confirm(`Are you sure you want to delete the draft assessment "${a.title}"?`)) {
      return;
    }
    setErrorMessage(null);
    try {
      ...
      setErrorMessage(err.error?.message || err.message || 'Failed to delete assessment.');
    }
  };
                          ...
                          {isDraft && (
                            <>
                              ...
                              <Button
                                variant="ghost"
                                size="sm"
                                onClick={() => handleDeleteDraftFromList(a)}
