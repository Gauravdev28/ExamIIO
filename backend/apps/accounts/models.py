...
class User(AbstractBaseUser, PermissionsMixin, UUIDModel, TimeStampedModel):
    ...
    def save(self, *args, **kwargs):
        ...
        # Use Django's native hasher registry rather than fragile string heuristics.
...
class StudentProfile(UUIDModel, TimeStampedModel):
    ...
    certificate_name = models.CharField(
        ...
        blank=True,
        default="",
        verbose_name="Full Name for Certificate Printing",
        help_text="Canonical student full name printed on Craft Society participation certificates."
    )
