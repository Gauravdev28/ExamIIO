...
urlpatterns = [
    ...
    # Ingestion: Spreadsheet (Excel/CSV)
    ...
    path('admin/questions/<uuid:pk>/duplicate/', AdminQuestionDuplicateView.as_view(), name='admin-question-duplicate'),
