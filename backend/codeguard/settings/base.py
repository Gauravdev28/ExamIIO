...
AUTH_PASSWORD_VALIDATORS = [
    # UserAttributeSimilarityValidator removed to allow candidate names in passwords
...
# Code Execution Provider Configuration (PISTON, JUDGE0)
CODE_EXECUTION_PROVIDER = os.getenv('CODE_EXECUTION_PROVIDER', 'PISTON').upper()

# Piston Isolated Execution Engine Configuration
PISTON_URL = os.getenv('PISTON_URL', 'http://127.0.0.1:2000')
PISTON_API_KEY = os.getenv('PISTON_API_KEY', '')
PISTON_TIMEOUT_SECONDS = int(os.getenv('PISTON_TIMEOUT_SECONDS', '10'))
