...
# Development only: eager Celery execution so local manual test runs execute synchronously
# without requiring an active Celery worker process. Production remains asynchronous (CELERY_TASK_ALWAYS_EAGER = False).
